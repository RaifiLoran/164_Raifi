...
class FormWTFAjouterGenres(FlaskForm):
    ...
    nom_genre_wtf = StringField("Nom objet ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFUpdateGenre(FlaskForm):
    ...
    nom_genre_update_wtf = StringField("nom objets ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFDeleteGenre(FlaskForm):
    ...
    """
    nom_genre_delete_wtf = StringField("Effacer cet objet")
    submit_btn_del = SubmitField("Effacer objet")
    submit_btn_conf_del = SubmitField("Etes-vous sur d'effacer ?")
    submit_btn_annuler = SubmitField("Annuler")

class FormWTFAttribuerObjet(FlaskForm):
    """
        Dans le formulaire "genre_update_wtf.html" on impose que le champ soit rempli.
        Définition d'un "bouton" submit avec un libellé personnalisé.
    """
